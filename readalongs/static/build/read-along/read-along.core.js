...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='read-along']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"ReadAlong","hydrated",[["read-along","read-along",1,[["alignment",1,0,1,2],["audio",1,0,1,2],["el",64],["image",1,0,1,2],["playing",16],["settings",16],["text",1,0,1,2],["theme",2,0,1,2]],1]]);